...
public class fileDownloadController {
	...
	public String fileDownloadList(Model model) {
		// File 객체 생성
		File path = new File("/Users/pizza/STS3/SpringWorkspace/upload");
	...
	public void fileDownload(@PathVariable String file,
		...
		// (1) 파일 객체 생성
		File f = new File("/Users/pizza/STS3/SpringWorkspace/upload/",file); //파일 다운로드 받으니까 뒤에 /붙임
		...
		response.setContentLength((int)f.length()); //int타입으로 형 변환
