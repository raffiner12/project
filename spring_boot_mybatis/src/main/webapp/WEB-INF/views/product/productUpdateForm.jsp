	...
	<body>
		<div id="wrap">
			...
			<form method="post" action="<c:url value='/product/updateProduct'/>">
				<table>
					<tr><td>상품번호 </td>
						<td><input type="text" name="prdNo" value="${prd.prdNo }" readonly></td></tr> <!-- 수정 못하게 readonly 로 막아놈 -->
					<tr><td>상품명  </td>
					...
					<tr><td>제조일 </td>
						<td> <input type="text" name="prdDate" value="<fmt:formatDate value="${prd.prdDate}"  
